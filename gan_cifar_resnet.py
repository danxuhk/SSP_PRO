...
with tf.Session() as session:
    ...
    for iteration in xrange(ITERS):
        ...
        lib.plot.plot(results_save + '/cost', _disc_cost)
        if CONDITIONAL and ACGAN:
            lib.plot.plot(results_save + '/wgan', _disc_wgan)
            lib.plot.plot(results_save + '/acgan', _disc_acgan)
            lib.plot.plot(results_save + '/acc_real', _disc_acgan_acc)
            lib.plot.plot(results_save + '/acc_fake', _disc_acgan_fake_acc)
        ...
        if iteration % INCEPTION_FREQUENCY == INCEPTION_FREQUENCY-1:
            ...
            lib.plot.plot(results_save + '/inception_50k', inception_score[0])
            lib.plot.plot(results_save + '/inception_50k_std', inception_score[1])
